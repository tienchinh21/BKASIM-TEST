...
namespace MiniAppGIBA.Services.EventGuests
{
    public interface IEventGuestService
    {
        ...
        Task<List<EventGuestDTO>> GetEventGuestListsWithRegistrationsAsync(string eventId, List<string>? allowedGroupIds = null, string? groupType = null);
        Task<List<EventGuestDTO>> GetAllEventGuestsWithRegistrationsAsync(List<string>? allowedGroupIds = null, string? groupType = null);
